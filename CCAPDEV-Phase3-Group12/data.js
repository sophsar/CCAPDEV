...
const owner_how_it_works = [
    {
        'info-name': 'Explore Your Restaurant\'s Reviews: ',
        'info': 'Dive into our vast collection of restaurant reviews to see what customers are saying about your establishment.'
    },
    {
        'info-name': 'Understand Star Ratings: ',
        'info': 'Our star ratings provide valuable insights into diners\' experiences at your restaurant. Whether it\'s the mouthwatering flavor of your signature dish or the exceptional service provided by your staff, let the star ratings guide potential customers to your culinary delights.'
    },
    {
        'info-name': 'Engage with the Community: ',
        'info': 'Interact with users to showcase the unique features of your restaurant and build lasting relationships with loyal customers.'
    }
];

module.exports.what_is = what_is;
module.exports.how_it_works = how_it_works;
module.exports.owner_what_is = owner_what_is;
module.exports.owner_how_it_works = owner_how_it_works;
